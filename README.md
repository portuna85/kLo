...
- 당첨번호 조회: 최신 회차, 특정 회차, 페이지 목록, 번호별 출현 빈도
- 당첨번호 수집: 동행복권 API 또는 mock client 기반 회차별 수집
- 추천 API: 1~10개 조합 생성, 제외 규칙 기반 편향 패턴 필터링
- 보안 기본값: 명시 허용 endpoint 외 차단, 주요 POST API IP 기반 rate limit
- 운영 편의: Actuator health, Flyway migration, Docker/Compose 배포 파일
